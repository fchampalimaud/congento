# Generated by Django 2.1.12 on 2019-09-13 13:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('congento_id', models.PositiveIntegerField(verbose_name='Congento ID')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='congento_fish_related', to='congento.Category')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='fish',
            name='species',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='congento_fish_related', to='congento.Species'),
        ),
    ]
